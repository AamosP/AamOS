...
const unsigned char fd_baselatin[] = {
/* Basic Latin */
...
const unsigned char fd_control[] = {
/* C1/C2 Control */
...
const unsigned char fd_ext_latin[] = {
/* Extended Latin */
...
const unsigned char fd_hiragana[] = {
/* Hiragana */
