...
unsigned char fd_ext_latin[] = {
/* Extended Latin */
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //U+00A0(no break space)
		0x18, 0x18, 0x00, 0x18, 0x18, 0x18, 0x18, 0x00, //U+00A1(inverted!)
		0x18, 0x18, 0x7E, 0x03, 0x03, 0x7E, 0x18, 0x18, //U+00A2(dollar cents)
		...
		0x3C, 0x36, 0x36, 0x7C, 0x00, 0x00, 0x00, 0x00, //U+00AA(superscripta)
		...
		0x18, 0x18, 0x7E, 0x18, 0x18, 0x00, 0x7E, 0x00, //U+00B1(plus minus)
		0x1C, 0x30, 0x18, 0x0C, 0x3C, 0x00, 0x00, 0x00, //U+00B2(superscript2)
		0x1C, 0x30, 0x18, 0x30, 0x1C, 0x00, 0x00, 0x00, //U+00B2(superscript3)
		...
		0x08, 0x0C, 0x08, 0x1C, 0x00, 0x00, 0x00, 0x00, //U+00B9(superscript1)
		0x1C, 0x36, 0x36, 0x1C, 0x00, 0x00, 0x00, 0x00, //U+00BA(superscript0)
		...
		0x0F, 0x06, 0x3E, 0x66, 0x66, 0x3E, 0x06, 0x0F, //U+00DE(T horn)
		...
		0x00, 0x00, 0xFE, 0x30, 0xFE, 0x33, 0xFE, 0x00, //U+00E6(a e)
		...
		0x1B, 0x0E, 0x1B, 0x30, 0x3E, 0x33, 0x1E, 0x00, //U+00F0(e th)
		...
		0x00, 0x00, 0x06, 0x3E, 0x66, 0x3E, 0x06, 0x00, //U+00FE(t horn)
		0x00, 0x33, 0x00, 0x33, 0x33, 0x3E, 0x30, 0x1F, //U+00FF(y umlaut)
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //U+0100
		};

unsigned char fd_greek[] = {
/* Greek Letters */
0x2D, 0x00, 0x0C, 0x0C, 0x0C, 0x2C, 0x18, 0x00, // U+0390(iota with tonos and diaeresis)
		...
		0x00, 0x00, 0x3E, 0x03, 0x03, 0x1E, 0x30, 0x1C, //U+03C2(sigma1)
		0x00, 0x00, 0x7E, 0x1B, 0x1B, 0x1B, 0x0E, 0x00, //U+03C3(sigma2)
...
//unsigned char *font_data = fd_baselatin;

char* get_font_data(uint32_t c) {
	if(c < 0x80) {
		return &fd_baselatin[c*8];
	} else if(c < 0xa0) {
		return &fd_control[(c-0x80)*8];
	} else if(c < 0x101) {
		return &fd_ext_latin[(c-0xa0)*8];
	} else if(0x390 <= c <= 0x3c9) {
		return &fd_greek[(c-0x390)*8];
	} else if(0x24ff < c < 0x2580) {
		return &fd_box[(c-0x2500)*8];
	} else return &fd_baselatin[0];
}
