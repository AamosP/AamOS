...
//#define SCANCODE_SET 3

#ifdef SCANCODE_SET 1
#define KEY_ESC 0x43
#define KEY_1 0x41
#define KEY_2 0x3f
#define KEY_3 0x3d
...
extern void init_kb(unsigned char scancode_set);
extern void read_kb();
extern unsigned char kb_data[5];
